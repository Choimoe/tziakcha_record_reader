...
class MahjongRecordParser:
    ...
    def _setup_wall_and_deal(self):
        ...
        wall_break_pos = (dice[0] + dice[1] - 1) % 4
        ...
        for p_packs in self.packs:
            for p_type, p_tile_str, _ in p_packs:
                if p_type == "PENG":
                    ...
                    all_tiles_revealed.extend([p_tile_str] * 4)

        print(all_tiles_revealed)
        print(self.get_tile_str(self.win_info['win_tile']))
        print(all_tiles_revealed.count(self.get_tile_str(self.win_info['win_tile'])))
        is_4th_tile = all_tiles_revealed.count(self.get_tile_str(self.win_info['win_tile'])) >= 3
