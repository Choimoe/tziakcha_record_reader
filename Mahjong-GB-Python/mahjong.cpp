...
static void MahjongInit() {
	for(int i = 1; i <= 9; ++i) {
		str2tile[to_string(i) + "m"] = mahjong::make_tile(TILE_SUIT_CHARACTERS, i);
		str2tile[to_string(i) + "p"] = mahjong::make_tile(TILE_SUIT_DOTS, i);
		str2tile[to_string(i) + "s"] = mahjong::make_tile(TILE_SUIT_BAMBOO, i);
	}
	str2tile["E"] = mahjong::make_tile(TILE_SUIT_HONORS, 1);
	str2tile["W"] = mahjong::make_tile(TILE_SUIT_HONORS, 2);
	str2tile["S"] = mahjong::make_tile(TILE_SUIT_HONORS, 3);
	str2tile["N"] = mahjong::make_tile(TILE_SUIT_HONORS, 4);
	str2tile["C"] = mahjong::make_tile(TILE_SUIT_HONORS, 5);
	str2tile["F"] = mahjong::make_tile(TILE_SUIT_HONORS, 6);
	str2tile["B"] = mahjong::make_tile(TILE_SUIT_HONORS, 7);
}
